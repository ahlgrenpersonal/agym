...
export function validateBackup(value: unknown): WorkoutBackup {
  if (!isObject(value) || value.format !== "agym-workout-backup") {
    throw new Error("This is not an AGym Workout backup file. Backups from other apps cannot be imported here.");
  }
