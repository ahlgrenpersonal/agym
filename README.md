...
- Trial starting loads (machine stack labels): leg press 70 lb; seated leg curl 40 lb; ab crunch 40 lb; hip abduction and adduction 40 lb each. These are adjustable starting suggestions, not demographic strength averages; machines differ. Adjust the load so the last good rep falls around the prescribed range (10–15 on the first three, 12–15 on the hip exercises). Choose the nearest lighter available setting and adjust to actual performance. Existing logged weights take priority.
